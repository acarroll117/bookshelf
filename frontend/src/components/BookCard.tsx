    ...
    <div className="flex gap-4 items-start bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-[0_4px_24px_rgba(99,102,241,0.1)] p-4">
      ...
      <div className={`relative flex-1 min-w-0 flex flex-col ${expanded ? "" : "h-56"}`}>
        ...
        <div className="absolute top-0 right-0 flex gap-1 z-10">
          <button
            onClick={() => onEdit(book)}
            className="p-1.5 text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300 transition-colors"
            aria-label="Edit"
          >
          ...
          <button
            ...
            className="p-1.5 text-gray-500 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-500 transition-colors"
            aria-label="Delete"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Stars and pages — bottom right */}
        <div className="mt-auto pt-3 flex-shrink-0 flex items-center justify-end gap-3">
          <StarRating value={book.score} size="sm" />
          {book.pages != null && (
            <span className="flex items-center gap-1.5 rounded bg-gray-100 dark:bg-gray-700 px-3 py-1 text-sm font-semibold text-gray-700 dark:text-gray-300">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 19.5A2.5 2.5 0 016.5 17H20" />
                <path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" />
              </svg>
